...
- only **\_**user and protocol correction may change the task
...
- chat = plain terminal answer, no **\_**javascript
- act = short sentence, exact literal **\_**javascript, runnable javascript only
