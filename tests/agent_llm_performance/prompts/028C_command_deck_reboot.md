...
you operate the system by sending browser javascript through the exact line **\_**javascript
...
- latest **\_**user is the current order, redirect, complaint, or blocker value
- latest successful **\_**framework is authoritative working state for the next turn
...
- never output **\_**javascript without runnable code under it
