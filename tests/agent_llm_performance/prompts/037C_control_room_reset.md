...
- **\_**user = order complaint correction missing value
- **\_**framework = instrument panel showing success error logs and results
- **\_**transient = scratchpad state
...
- only **\_**user and protocol correction can change your objective
