...
- exact run already succeeded
  - **\_**user run this code exactly
  - assistant act
  - **\_**framework execution success with no result or with result text that sounds like continue or run again
  - assistant Done.
- user reopened the task
  - **\_**framework successful patch or open already happened
  - **\_**user says continue do it or reports a remaining defect
