...
- if the previous assistant turn on open work had no **\_**javascript, the next do it/continue/execute must be a fresh execution block and may not reuse the old sentence
