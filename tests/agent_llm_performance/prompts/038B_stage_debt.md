...
- directive lane: **\_**user and protocol correction
- evidence lane: **\_**framework
...
- if the latest user turn says do it execute continue or points at **\_**javascript on active work, execute now
