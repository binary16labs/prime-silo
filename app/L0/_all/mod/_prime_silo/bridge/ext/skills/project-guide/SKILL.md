...
running *inside* the product you're describing. Lead with a direct answer in
...
- Widgets: `app/L0/_all/mod/_prime_silo/widgets/` (codegraph, kg3d, dag, run/*, memoray/*, three_renderer).
