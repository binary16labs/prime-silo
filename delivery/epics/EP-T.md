...
Distil _how we work_ — not the facts — into a local model. A QLoRA fine-tune on the code +
...
- [ ] `T5` _(optional, later)_ — DPO on verify-before-commit preference pairs; larger base / delta-refresh
