# EP-F — Product features wave one

**Objective:** O3 · **Goals:** P8,P9 · **Milestone:** M1
**Plan source:** `../../architecture/PLAN-local-power-unified-ui.md` (workstream F)
...
- [ ] `F6` — run diffing (CLI+UI parity)
- [ ] `F7` — PRIME_SILO_HOME backup/restore (hash-manifested)
