# EP-C — One Prime-Silo (shell + de-brand + accessibility)

**Objective:** O3 · **Goals:** P5 · **Milestone:** M1
**Plan source:** `../../architecture/PLAN-local-power-unified-ui.md` (workstream C)
...
- [x] `C3` — login + first-run retheme (Prime-Silo branding & dark warm charcoal canvas)
- [x] `C4` — de-brand pass (user-facing strings updated to Prime-Silo across shells & titles)
- [x] `C5` — mascot micro-states (benny-breathing idle, hover scale & glow, reduced-motion honored)
- [ ] `C7` — cognitive profiles (Focus/Reading/Zen presets, reading ruler)
