      ...
      items: [
        ...
        SysTray.separator,
        {
          ...
          items: [
            {
              title: "Port 3000",
              tooltip: "Use port 3000",
              enabled: true,
              checked: currentPort === 3000
            },
            {
              title: "Port 3030",
              tooltip: "Use port 3030",
              enabled: true,
              checked: currentPort === 3030
            },
            {
              title: "Port 3002",
              tooltip: "Use port 3002",
              enabled: true,
              checked: currentPort === 3002
            },
            {
              title: "Port 3003",
              tooltip: "Use port 3003",
              enabled: true,
              checked: currentPort === 3003
            },
            {
              title: "Port 8080",
              tooltip: "Use port 8080",
              enabled: true,
              checked: currentPort === 8080
            }
          ]
        },
        SysTray.separator,
  ...
  systray.onClick((action) => {
    ...
    if (title === "Open Dashboard") {
      ...
      setTimeout(() => {
        ...
        const toggleItem = action.menu.items.find(
          (i) => i.title === "Start Service" || i.title === "Stop Service"
        );
        if (toggleItem) {
