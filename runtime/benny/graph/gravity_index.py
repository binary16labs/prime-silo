...
class GravityIndex:
    ...
    def _compute_forces(self, iterations: int = 25):
        ...
        for i in range(iterations):
            ...
            for j, v in enumerate(self.nodes):
                ...
                for k_idx, u in enumerate(self.nodes):
                    ...
                    if dist_sq > cutoff_sq:
                        continue  # Optimization: Skip if too far
            ...
            for v in self.nodes:
                ...
                # Keep within bounds
                self.positions[v_id] = [max(-100, min(100, x)) for x in self.positions[v_id]]
    ...
    async def run(self):
        ...
        return {"status": "completed", "node_count": len(self.nodes), "bounds": [-100, 100]}
