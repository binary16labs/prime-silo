            ...
            [
                {
                    ...
                    "type": "llm",
                    "position": {"x": 300, "y": 0},
                    "data": {"label": "Planner (Bricoleur)", "config": {"persona": "Architect"}},
                },
                {
                    "id": "strat_logic",
                    "type": "logic",
                    "position": {"x": 300, "y": 120},
                    "data": {"label": "Orchestrator", "config": {"operation": "Command"}},
                },
                {
                    "id": "strat_worker",
                    "type": "tool",
                    "position": {"x": 300, "y": 240},
                    "data": {"label": "Executor Mesh", "config": {"tool": "swarm_execution"}},
                },
                {
                    "id": "strat_data",
                    "type": "data",
                    "position": {"x": 300, "y": 360},
                    "data": {"label": "Aggregator (Kludge)", "config": {"operation": "combine"}},
                },
            ]
        )
            ...
            for file_path in WORKSPACE_WORKFLOWS.glob("*.json"):
                try:
                    with open(file_path, "r", encoding="utf-8") as f:
                        data = json.load(f)
                        workflows.append({**data, "type": "user", "file_path": str(file_path)})
